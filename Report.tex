...
\begin{claim}[Стійкість Cramer--Shoup~\cite{CramerShoup1998}]
...
\begin{proof}
    ...
    перетворення (NM-CPA)~\cite{KatzLindell2020}.
    \begin{equation*}
...
\begin{table}[htbp]
    ...
    \begin{flushleft}
        \small
        * --- за припущення складності RSA-задачі; ** --- за припущення DDH; *** --- у моделі випадкового оракула; $\star$ -- за припущення Module-LWE.\\
